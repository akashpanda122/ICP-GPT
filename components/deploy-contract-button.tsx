...
//import { useDeployWithWallet } from '@/lib/function/deploy-contract/wallet-deploy'
...
export function DeployContractButton({ sourceCode }: { sourceCode: string }) {
    ...
    //function to get the constructor argumnets from the source code
    const getConstructorArgs = () => {
        ...
        const trimedConstructorArgsArray = constructorArgsArray.map(arg => 
            arg.trim()
        )
        //return the array of constructor argumnets
        return trimedConstructorArgsArray
    }
    ...
    //handler for deploying with wallet
        ...
        <div className="ml-4 flex w-full justify-end">
            ...
            >
                ...
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <div className="flex flex-col itmes-center gap-4 py-4">
                        {isErrorDeploying && (
