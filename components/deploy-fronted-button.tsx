...
export function DeployFrontentButton({
    sourceCode,
    address,
    abi
}: {
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription className="pt-2">
                        Deploy your frontend on chain. One deployment will be on the Juno blockchain the other will be on ICP as a frontend canister.
                    </DialogDescription>
                </DialogHeader>
